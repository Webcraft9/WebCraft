    ...
    <div class="d-flex flex-column justify-content-center align-items-center" style="height: 100%;">
        ...
        <div class="card shadow" style="width: 400px;">
            <div class="card-body">  
                ...
                <center><h2 class="text-danger mb-4" style="color:#f60; font-size:3rem;">Iniciar Sesión como</h2></center>
                    
                      <a clas="btn btn-orange position-absolute" href="Usuario/Login.php"><button type="button" class="btn btn-orange btn-block">Usuario</button></a><br>
                      <a clas="btn btn-orange position-absolute" href="Administrador/LoginA.php"><button type="button" class="btn btn-orange btn-block">Administrador</button></a>
                </form>
            </div>
        </div>
    </div>
