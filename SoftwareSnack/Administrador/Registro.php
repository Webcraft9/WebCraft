            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="PerfilA.php">Mi perfil</a></li>
                    </ul>
                </li>
                <li class="nav-item">
...
<div style="bottom:-6rem; height:5rem;"class="container-fluid position-relative vh-100">
    ...
    <a href="../RegistroComo.php" class="btn btn-orange position-absolute" style="bottom: 5.5rem; right: 1rem;">Atrás</a>
</div>
