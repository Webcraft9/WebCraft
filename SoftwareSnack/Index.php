...
<body>
    ...
    <div class="row">
        ...
        <div class="card-header" style="margin:-0.8rem; padding:-1rem;">De la casa</div>
        ...
        <div class="card" style="width: 18rem;">
        <div class="card-header" style="margin:-0.8rem; padding:-1rem;">Salchipapa</div>
        <img src="Doriloco.png" class="card-img-top" alt="...">
        <div class="card-body">
        ...
        <div class="card" style="width: 18rem;">
        <div class="card-header" style="margin:-0.8rem; padding:-1rem;">Perro caliente</div>
        ...
        <div class="card" style="width: 18rem;">
        <div class="card-header" style="margin:-0.8rem; padding:-1rem;">Especiales</div>
        <img src="Choriloco.png" class="card-img-top" alt="...">
        <div class="card-body">
