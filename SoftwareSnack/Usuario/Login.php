...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email) || empty($password)) {
        ...
        $query = "SELECT * FROM Usuarios WHERE password = '$password'"; // Cambié 'passwordd' a 'password'
        $result = $conn->query($query);
            ...
            <div class="card-body">  
                ...
                <center><h2 class="text-danger mb-4" style="color:#f60; font-size:3rem;">Iniciar Sesión</h2></center>
                    ...
                    <form action="verificar_contrasena.php" method="post">
                      ...
                      <a clas="btn btn-orange position-absolute" href="Index.php"><button type="submit" class="btn btn-orange btn-block">Continuar</button></a>
                </form>
            </div>
        </div>
    </div>
    <a href="../Iniciar.php" class="btn btn-orange position-absolute" style="bottom: 9rem; right: 1rem;">Atrás</a>
</div>
