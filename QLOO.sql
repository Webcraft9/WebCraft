...
('Coca Cola', 1, 6000.00, 100), -- 1.50 USD
('Hamburguesa Clásica', 2, 23960.00, 50), -- 5.99 USD
('Pizza Pepperoni', 3, 35960.00, 30), -- 8.99 USD
('Papas Fritas', 4, 11960.00, 75), -- 2.99 USD
('Cheesecake', 5, 14000.00, 40), -- 3.50 USD
('Ensalada César', 6, 18000.00, 25), -- 4.50 USD
('Desayuno Continental', 7, 28000.00, 20), -- 7.00 USD
('Sandwich de Pollo', 8, 26000.00, 35), -- 6.50 USD
('Taco de Carne', 9, 10000.00, 60), -- 2.50 USD
('Salsa BBQ', 10, 4800.00, 80); -- 1.20 USD
